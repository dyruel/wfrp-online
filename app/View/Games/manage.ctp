  ...
  <div id="rpg-tabs">
    ...
    <div id="rpg-tabs-1">
      ...
      <?php if(sizeof($t_data['CharactersSkillsSkillspec']) > 0): ?>
        <div class="rpg-accordion">
          <?php foreach ($t_data['CharactersSkillsSkillspec'] as $skill): ?>
            ...
            :
            <?php
              if(!empty($skill['Skillspec'])):
                echo $skill['Skillspec']['name'];                
              endif;
            ?>
            ...
            <div>
            <p><?php echo __('Characteristic'); ?>: <?php echo $t_data['Character']['profile']['current'][$skill['Skill']['carac']]; ?></p>
            <p>
      ...
      <!-- IF .talents -->
        <div class="rpg-accordion">
          <!-- BEGIN talents -->
            <h3>{talents.TALENT_NAME}
              <!-- BEGIN spec -->
              : {talents.spec.TALENT_SPEC}
              <!-- END spec -->
            </h3>
            <div>
            <p>
    ...
    <div id="rpg-tabs-2">
	    <div class='equip'>
	    <div class='equip_structure' style='background-image: url("{PHPBB_ROOT_PATH}rpg/img/inv_{GENDER_ID}.png");'>&nbsp;</div>
		    <!-- BEGIN equip -->
